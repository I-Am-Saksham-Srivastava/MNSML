...
/// An Exception class to capture mnsml specific exceptions
class mnsmlException extends Error implements Exception {
  mnsmlException(this.message);
...
class mnsmlCyclicReactionException extends mnsmlException {
  mnsmlCyclicReactionException(super.message);
}

/// This captures the stack trace when user-land code throws an exception
class mnsmlCaughtException extends mnsmlException {
  mnsmlCaughtException(Object exception, {required StackTrace stackTrace})
    : _exception = exception,
      _stackTrace = stackTrace,
      super('mnsmlCaughtException: $exception');
