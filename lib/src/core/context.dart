...
class ReactiveConfig {
  ...
  /// Whether mnsml should throw exceptions instead of catching them and store
...
class ReactiveContext {
  ...
  T? trackDerivation<T>(Derivation d, T Function() fn) {
    ...
    if (config.disableErrorBoundaries == true) {
      ...
      try {
        ...
        d._errorValue = mnsmlCaughtException(e, stackTrace: s);
      }
    }
  ...
  bool _hasCaughtException(Derivation d) =>
      d._errorValue is mnsmlCaughtException;
