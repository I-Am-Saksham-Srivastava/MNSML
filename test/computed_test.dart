...
import 'package:mnsml/mnsml.dart' hide when;
import 'package:mnsml/src/utils.dart';
...
void main() {
  ...
  group('Computed', () {
    ...
    test('throws on finding a cycle', () {
      ...
      // ignore: avoid_as
      expect(
        (c1.errorValue?.exception as mnsmlException).message.toLowerCase(),
        contains('cycle'),
      );
    });
